...
public class WorkerStarter {
  ...
  public static void main(final String[] args) {
    ...
    if (isWorker) {
      final SinglePipeConnector<IRecord> tcpConnectorConnector =
          new SinglePipeConnector<>(Constants.TRACE_SUMMARIZATION_DISRUPTOR_SIZE);
      ...
      final SinglePipeConnector<IRecord> recordCountingConnector =
          new SinglePipeConnector<>(Constants.TRACE_SUMMARIZATION_DISRUPTOR_SIZE);
