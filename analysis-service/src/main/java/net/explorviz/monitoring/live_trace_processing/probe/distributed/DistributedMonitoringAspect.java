...
public abstract class DistributedMonitoringAspect extends AbstractAspect {
  ...
  /**
   * This method checks the ProbeContoller.monitoringEnabled variable to prevent monitoring of calls
   * that are made from the monitoring probes.
   */
  @Override
  protected Object createEventRecords(final ProceedingJoinPoint thisJoinPoint,
    ...
    if (DistributedMonitoringTempDisabler.getProbeController().isMonitoringEnabled()) {
      return super.createEventRecords(thisJoinPoint,
          beforeLength,
          beforeId,
          afterFailedLength,
          afterFailedId,
