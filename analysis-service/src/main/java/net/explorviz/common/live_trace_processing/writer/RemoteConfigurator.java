...
public class RemoteConfigurator {
  public static void addPattern(final String host, final String pattern, final String application) {
  ...
  private static void sentCommand(final String host, final String action, final String pattern,
      final String application) {
    try {

      final SocketChannel socketChannel =
          SocketChannel.open(new InetSocketAddress(host, RemoteConfigurationServlet.PORT));
  ...
  private static void putStringIntoBuffer(final String value, final ByteBuffer buffer) {
