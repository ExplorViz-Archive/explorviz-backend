...
public class BeforeSentRemoteCallRecord extends AbstractBeforeEventRecord {
  ...
  public static final int COMPRESSED_BYTE_LENGTH =
      AbstractBeforeEventRecord.COMPRESSED_BYTE_LENGTH + 4;
  ...
  public BeforeSentRemoteCallRecord(final String technology, final long traceId,
  ...
  public BeforeSentRemoteCallRecord(final ByteBuffer buffer,
    ...
    this.technology = stringRegistry.getStringFromId(buffer.getInt());
  }
  ...
  public void putIntoByteBuffer(final ByteBuffer buffer, final StringRegistrySender stringRegistry,
    ...
    buffer.putInt(stringRegistry.getIdForString(this.technology));
  }
  ...
  public int compareTo(final IRecord o) {
    if (o instanceof BeforeSentRemoteCallRecord) {
      ...
      final int cmpTechnology = this.getTechnology().compareTo(record2.getTechnology());
      if (cmpTechnology != 0) {
        return cmpTechnology;
      }

      final long cmpTraceId = this.traceId - record2.traceId;
      if (cmpTraceId != 0) {
  ...
  public String toString() {
    return BeforeSentRemoteCallRecord.class.getSimpleName() + " - " + super.toString()
        + ", getTechnology()=" + this.getTechnology();
  }
}
