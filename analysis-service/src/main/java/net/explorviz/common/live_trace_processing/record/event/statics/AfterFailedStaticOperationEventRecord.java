...
public class AfterFailedStaticOperationEventRecord extends AbstractAfterFailedEventRecord {
  public static final byte CLAZZ_ID = 12;
  public static final byte CLAZZ_ID_FROM_WORKER = CLAZZ_ID + 64;

  public AfterFailedStaticOperationEventRecord(final long timestamp, final long traceId,
  ...
  public String toString() {
    return AfterFailedStaticOperationEventRecord.class.getSimpleName() + " - " + super.toString();
  }
}
