...
public class AfterFailedConstructorEventRecord extends
	...
	public AfterFailedConstructorEventRecord(final long timestamp,
	...
	public String toString() {
		return AfterFailedConstructorEventRecord.class.getSimpleName() + " - "
				+ super.toString();
	}
}
