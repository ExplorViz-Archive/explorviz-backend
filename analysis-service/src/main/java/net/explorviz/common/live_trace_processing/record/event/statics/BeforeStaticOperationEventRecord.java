...
public class BeforeStaticOperationEventRecord extends
	...
	public static final int COMPRESSED_BYTE_LENGTH = AbstractBeforeOperationEventRecord.COMPRESSED_BYTE_LENGTH - 4; // objectId
	public static final int COMPRESSED_BYTE_LENGTH_WITH_CLAZZ_ID = 1 + COMPRESSED_BYTE_LENGTH;

	public BeforeStaticOperationEventRecord(final long traceId,
		...
		super(traceId, orderIndex, 0, operationSignature, clazz,
	...
	public String toString() {
		return BeforeStaticOperationEventRecord.class.getSimpleName() + " - "
				+ super.toString();
	}
}