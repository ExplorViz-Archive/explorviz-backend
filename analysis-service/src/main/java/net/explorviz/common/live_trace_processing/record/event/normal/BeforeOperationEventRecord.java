...
public class BeforeOperationEventRecord extends AbstractBeforeOperationEventRecord {
  public static final byte CLAZZ_ID = 1;
  public static final byte CLAZZ_ID_FROM_WORKER = CLAZZ_ID + 64;

  public BeforeOperationEventRecord(final long traceId, final int orderIndex, final int objectId,
  ...
  public String toString() {
    return BeforeOperationEventRecord.class.getSimpleName() + " - " + super.toString();
  }
}
