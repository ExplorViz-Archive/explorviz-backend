...
public class AfterStaticOperationEventRecord extends AbstractAfterEventRecord {
  ...
  public AfterStaticOperationEventRecord(final long timestamp, final long traceId,
  ...
  public String toString() {
    return AfterStaticOperationEventRecord.class.getSimpleName() + " - " + super.toString();
  }
}
