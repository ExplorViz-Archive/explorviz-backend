...
public class LoadBalancerIPFetcher extends Thread {
	...
	public LoadBalancerIPFetcher(final URL loadBalancerProviderURL,
			final int timeIntervalToWait, final ILoadBalancerIPReceiver receiver) {
	...
	public void run() {
		while (!Thread.interrupted()) {
			try {
				...
				receiver.receivedNewIp(newProviderURL);
	...
	private URL fetchNewProviderURL() throws IOException,
