...
public class DebugFileByteBufferReader {
  ...
  public static void main(final String[] args) {
    ...
    try {
      final SocketChannel socketChannel =
          SocketChannel.open(new InetSocketAddress("127.0.0.1", 10133));
  ...
  public static ByteBuffer readOneByteBuffer() throws IOException {
    final ByteBuffer metaBuffer =
        ByteBuffer.allocateDirect(HostApplicationMetaDataRecord.BYTE_LENGTH_WITH_CLAZZ_ID);
    try {
