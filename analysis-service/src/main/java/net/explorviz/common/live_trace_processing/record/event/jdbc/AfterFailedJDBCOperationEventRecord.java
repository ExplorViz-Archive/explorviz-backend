...
public class AfterFailedJDBCOperationEventRecord extends
	...
	public AfterFailedJDBCOperationEventRecord(final long timestamp,
	...
	public String toString() {
		return AfterFailedJDBCOperationEventRecord.class.getSimpleName()
				+ " - " + super.toString();
	}
}
