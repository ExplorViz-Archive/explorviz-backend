...
public class BeforeConstructorEventRecord extends
	...
	public BeforeConstructorEventRecord(final long traceId,
	...
	public String toString() {
		return BeforeConstructorEventRecord.class.getSimpleName() + " - "
				+ super.toString();
	}
}