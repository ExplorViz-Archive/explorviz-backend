...
public abstract class AbstractAfterFailedEventRecord extends AbstractEventRecord {
  public static final int COMPRESSED_BYTE_LENGTH =
      8 + 4 + AbstractEventRecord.COMPRESSED_BYTE_LENGTH;
  ...
  public AbstractAfterFailedEventRecord(final long methodDuration, final long traceId,
  ...
  public AbstractAfterFailedEventRecord(final ByteBuffer buffer,
    ...
    this.cause = stringRegistry.getStringFromId(buffer.getInt());
  }
  ...
  public String toString() {
    return AbstractAfterFailedEventRecord.class.getSimpleName() + " - " + super.toString()
        + ", getCause()=" + this.getCause();
  }
}
