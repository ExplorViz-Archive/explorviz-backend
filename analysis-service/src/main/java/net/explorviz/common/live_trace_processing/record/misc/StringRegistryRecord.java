...
public class StringRegistryRecord implements ISerializableRecord {
	...
	public void putIntoByteBuffer(final ByteBuffer buffer,
		...
		final byte[] valueAsBytes = getValue().getBytes();
	...
	public int getRecordSizeInBytes() {
		...
		return StringRegistryRecord.BYTE_LENGTH_WITHOUT_STRING_WITH_CLAZZ_ID
				+ valueAsBytes.length;
	}
	...
	public String toString() {
		return "StringRegistryRecord [value=" + value + ", id=" + id + "]";
	}
}
