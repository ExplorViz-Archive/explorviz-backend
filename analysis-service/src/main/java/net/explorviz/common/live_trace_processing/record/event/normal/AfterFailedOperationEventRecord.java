...
public class AfterFailedOperationEventRecord extends
	...
	public AfterFailedOperationEventRecord(final long timestamp,
	...
	public String toString() {
		return AfterFailedOperationEventRecord.class.getSimpleName() + " - "
				+ super.toString();
	}
}
