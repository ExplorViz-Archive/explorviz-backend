...
public class AfterFailedOperationEventRecord extends AbstractAfterFailedEventRecord {
  public static final byte CLAZZ_ID = 2;
  public static final byte CLAZZ_ID_FROM_WORKER = CLAZZ_ID + 64;

  public AfterFailedOperationEventRecord(final long timestamp, final long traceId,
  ...
  public AfterFailedOperationEventRecord(final ByteBuffer buffer,
  ...
  public int compareTo(final IRecord o) {
    if (o instanceof AfterFailedOperationEventRecord) {
  ...
  public String toString() {
    return AfterFailedOperationEventRecord.class.getSimpleName() + " - " + super.toString();
  }
}
