...
public class BeforeJDBCOperationEventRecord extends AbstractBeforeOperationEventRecord {
  ...
  public static final int COMPRESSED_BYTE_LENGTH =
      AbstractBeforeOperationEventRecord.COMPRESSED_BYTE_LENGTH + 4;
  ...
  public BeforeJDBCOperationEventRecord(final long traceId, final int orderIndex,
  ...
  public BeforeJDBCOperationEventRecord(final ByteBuffer buffer,
    ...
    this.sqlStatement = stringRegistry.getStringFromId(buffer.getInt());
  }
  ...
  public void putIntoByteBuffer(final ByteBuffer buffer, final StringRegistrySender stringRegistry,
    ...
    buffer.putInt(stringRegistry.getIdForString(this.getSqlStatement()));
  }
  ...
  public int compareTo(final IRecord o) {
    if (o instanceof BeforeJDBCOperationEventRecord) {
      ...
      final int cmpSQLStatement = this.getSqlStatement().compareTo(record2.getSqlStatement());
  ...
  public String toString() {
    return BeforeJDBCOperationEventRecord.class.getSimpleName() + " - " + super.toString()
        + ", getSQLStatement()=" + this.getSqlStatement();
  }
