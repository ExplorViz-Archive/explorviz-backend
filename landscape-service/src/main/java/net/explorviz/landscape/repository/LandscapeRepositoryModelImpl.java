...
@Service
@Singleton
public final class LandscapeRepositoryModelImpl implements LandscapeRepositoryModel {

  private static final Logger LOGGER = LoggerFactory.getLogger(LandscapeRepositoryModelImpl.class);
  ...
  @Inject
  public LandscapeRepositoryModelImpl(final LandscapeSerializationHelper serializationHelper,
  ...
  @Override public void insertIntoModel(final IRecord inputIRecord) {
    // called every second
