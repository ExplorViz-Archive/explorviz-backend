...
public final class DummyLandscapeHelper {
  ...
  public static System createSystem(final String name, final Landscape parentLandscape) {
    ...
    // create new event
    LandscapeHelper.createEvent(parentLandscape, EEventType.NEWSYSTEM,
  ...
  public static Node createNode(final String ipAddress, final NodeGroup parentNodeGroup,
    ...
    // create a new event
    LandscapeHelper.createEvent(landscape, EEventType.NEWNODE, "New node '" + node.getIpAddress()
  ...
  public static Application createApplication(final String name, final Node parentNode,
    ...
    // create a new event
    LandscapeHelper.createEvent(landscape, EEventType.NEWAPPLICATION, "New application '"
        + application.getName() + "' on node '" + parentNode.getName() + "' detected");
