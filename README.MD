...
3. Start the [TestApplication](https://github.com/czirkelbach/kiekerSampleApplication) as described [https://github.com/czirkelbach/kiekerSampleApplication/blob/master/README.md] here.
