# ExplorViz Backend
[![Build Status](https://build.se.informatik.uni-kiel.de/jenkins/buildStatus/icon?job=explorviz-backend)](http://build.se.informatik.uni-kiel.de/jenkins/job/ExplorViz-backend/)
