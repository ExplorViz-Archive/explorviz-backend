# ExplorViz Backend
[![](http://build.se.informatik.uni-kiel.de/jenkins/buildStatus/icon?job=explorviz-backend)](http://build.se.informatik.uni-kiel.de/jenkins/job/explorviz-backend/)
