...
public class DefaultSettings {
  ...
  public static FlagSetting appVizTransparency =
      new FlagSetting("appVizTransparency", "Enable Transparent Components",
          ...
          true);
  public static FlagSetting keepHighlightingOnOpenOrClose =
      new FlagSetting("keepHighlightingOnOpenOrClose", "Keep Highlighting On Open Or Close",
          "Toggle if highlighting should be resetted on double click in application"
              + " visualization", origin, true);
  public static FlagSetting enableHoverEffects =
      new FlagSetting("enableHoverEffects", "Enable Hover Effects",
          "Hover effect (flashing entities) for mouse cursor", origin, true);

  public static RangeSetting appVizCommArrowSize =
      new RangeSetting("appVizCommArrowSize", "Arrow Size in Application Visualization",
          ...
          5.0);
  public static RangeSetting appVizTransparencyIntensity =
  ...
  public static RangeSetting appVizCurvyCommHeight =
      new RangeSetting("appVizCurvyCommHeight", "Curviness of the Communication Lines",
          "If greater 0.0, communication lines are rendered arc-shaped with set height (Straight "
              + "lines: 0.0)", origin, 0.0, 0.0, 50.0);


  public static List<Setting> all = new ArrayList<>(Arrays.asList(
      showFpsCounter, appVizTransparency, keepHighlightingOnOpenOrClose,
      enableHoverEffects, appVizCommArrowSize,
      appVizTransparencyIntensity, appVizCurvyCommHeight
  ));
