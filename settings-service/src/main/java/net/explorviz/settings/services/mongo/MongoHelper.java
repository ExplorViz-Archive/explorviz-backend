 ...
 */
public class MongoHelper { // NOPMD

  private static final Logger LOGGER = LoggerFactory.getLogger(MongoHelper.class);

  private static final String DEFAULT_HOST = "localhost";
  private static final String DEFAULT_PORT = "27019";
  private static final String DEFAULT_DB = "explorviz";
  private static final String USERSETTINGS_COLLECTION = "usersetting";
  ...
  /**
   * Returns a connection to the user settings collection.
   */
  public MongoCollection<Document> getUserSettingsCollection() {
    return this.getDatabase().getCollection(USERSETTINGS_COLLECTION);
  }
