...
public class UserSettingsRepositoryTest {
  ...
  public void setUp() {
    ...
    userSettings = new ArrayList<>(Arrays.asList(new UserSetting("1", "bid", Boolean.TRUE),
        new UserSetting("1", "sid", "val"), new UserSetting("1", "did", 0.4)));
  }
  ...
  public void testGetAll() {
    ...
    List<UserSetting> returnList = userSettings.stream()
        .filter(u -> u.getId().getUserId().equals(id)).collect(Collectors.toList());
