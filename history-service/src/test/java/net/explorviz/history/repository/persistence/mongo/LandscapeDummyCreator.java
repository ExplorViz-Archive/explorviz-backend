...
public final class LandscapeDummyCreator {
  ...
  public static Landscape createDummyLandscape(final IdGenerator idGen) {
     ...
     *
     * final NodeGroup requestsNodeGroup = DummyLandscapeHelper.createNodeGroup("10.0.99.1",
     * requestSystem); final Node requestsNode = DummyLandscapeHelper.createNode("10.0.99.1",
     * requestsNodeGroup, landscape);
     *
     * final Application requestsApp = DummyLandscapeHelper.createApplication("Requests",
     * requestsNode, landscape);
     *
     ...
     *
     * final NodeGroup ocnEditorNodeGroup = DummyLandscapeHelper.createNodeGroup("10.0.1.1",
     * ocnEditor); final Node ocnEditorNode = DummyLandscapeHelper.createNode("10.0.1.1",
     * ocnEditorNodeGroup, landscape); final Application ocnEditorApp =
     * DummyLandscapeHelper.createApplication("Frontend", ocnEditorNode, landscape);
     *
     * final NodeGroup ocnEditorNodeGroup2 = DummyLandscapeHelper.createNodeGroup("10.0.1.2",
     * ocnEditor); final Node ocnEditorNode2 = DummyLandscapeHelper.createNode("10.0.1.2",
     * ocnEditorNodeGroup2, landscape); final Application ocnEditorApp2 =
     ...
     *
     * final NodeGroup ocnDatabaseNodeGroup = DummyLandscapeHelper.createNodeGroup("10.0.2.1",
     * ocnDatabase); final Node ocnDatabaseNode = DummyLandscapeHelper.createNode("10.0.2.1",
     * ocnDatabaseNodeGroup, landscape); final Application ocnDatabaseApp =
     * DummyLandscapeHelper.createApplication("Interface", ocnDatabaseNode, landscape);
     *
     * final NodeGroup ocnDatabaseNodeGroup2 = DummyLandscapeHelper.createNodeGroup("10.0.2.2",
     * ocnDatabase); final Node ocnDatabaseNode2 = DummyLandscapeHelper.createNode("10.0.2.2",
     * ocnDatabaseNodeGroup2, landscape); final Application ocnDatabaseApp2 =
     ...
     *
     * kielprints.setName("OceanRep"); kielprints.setParent(landscape);
     * landscape.getSystems().add(kielprints);
     *
     * final NodeGroup kielprintsNodeGroup = DummyLandscapeHelper.createNodeGroup("10.0.3.1",
     * kielprints); final Node kielprintsNode = DummyLandscapeHelper.createNode("10.0.3.1",
     * kielprintsNodeGroup, landscape); final Application kielprintsApp =
     * DummyLandscapeHelper.createApplication("Webinterface", kielprintsNode, landscape); final
     * Application kielprintsApp2 = DummyLandscapeHelper.createApplication("Eprints",
     * kielprintsNode, landscape);
     *
     * final NodeGroup kielprintsNodeGroup2 = DummyLandscapeHelper.createNodeGroup("10.0.3.2",
     * kielprints); final Node kielprintsNode2 = DummyLandscapeHelper.createNode("10.0.3.2",
     * kielprintsNodeGroup2, landscape); final Application kielprintsApp3 =
     ...
     * final Node portalNode = DummyLandscapeHelper.createNode("10.0.4.1", portalNodeGroup,
     * landscape); final Application portalApp = DummyLandscapeHelper.createApplication("Wiki",
     * portalNode, landscape);
     *
     * final NodeGroup portalNodeGroup2 = DummyLandscapeHelper.createNodeGroup("10.0.4.2", portal);
     * final Node portalNode2 = DummyLandscapeHelper.createNode("10.0.4.2", portalNodeGroup2,
     * landscape); final Application portalApp2 =
     * DummyLandscapeHelper.createApplication("Artifacts", portalNode2, landscape);
     *
     * portalNodeGroup.getNodes().add(portalNode); portal.getNodeGroups().add(portalNodeGroup);
     * portalNodeGroup2.getNodes().add(portalNode2); portal.getNodeGroups().add(portalNodeGroup2);
     *
     ...
     * final Node pangeaNode = DummyLandscapeHelper.createNode("10.0.5.1", pangeaNodeGroup,
     * landscape); final Application pangeaApp = DummyLandscapeHelper.createApplication("4D",
     * pangeaNode, landscape);
     *
     * final NodeGroup pangeaNodeGroup2 = DummyLandscapeHelper.createNodeGroup("10.0.5.2", pangea);
     * final Node pangeaNode2 = DummyLandscapeHelper.createNode("10.0.5.2", pangeaNodeGroup2,
     * landscape); final Application pangeaApp2 = DummyLandscapeHelper.createApplication("Jira",
     * pangeaNode2, landscape); final Application pangeaApp3 =
     * DummyLandscapeHelper.createApplication("PostgreSQL", pangeaNode2, landscape);
     *
     * pangeaNodeGroup.getNodes().add(pangeaNode); pangea.getNodeGroups().add(pangeaNodeGroup);
     * pangeaNodeGroup2.getNodes().add(pangeaNode2); pangea.getNodeGroups().add(pangeaNodeGroup2);
     *
     * final System pubflow = new System(idGen.generateId());
     *
     * pubflow.setName("PubFlow"); pubflow.setParent(landscape);
     * landscape.getSystems().add(pubflow);
     *
     * final NodeGroup jiraNodeGroup = DummyLandscapeHelper.createNodeGroup("10.0.0.1 - 10.0.0.2",
     * pubflow);
     *
     * final Node jira1Node = DummyLandscapeHelper.createNode("10.0.0.1", jiraNodeGroup, landscape);
     * final Application jira1 = DummyLandscapeHelper.createApplication("Jira", jira1Node,
     * landscape);
     *
     * final Node jira2Node = DummyLandscapeHelper.createNode("10.0.0.2", jiraNodeGroup, landscape);
     * final Application jira2 = DummyLandscapeHelper.createApplication("Jira", jira2Node,
     * landscape);
     *
     * jiraNodeGroup.getNodes().add(jira1Node); jiraNodeGroup.getNodes().add(jira2Node);
     * pubflow.getNodeGroups().add(jiraNodeGroup);
     *
     * final NodeGroup postgreSqlNodeGroup = DummyLandscapeHelper.createNodeGroup("10.0.0.3",
     * pubflow); final Node postgreSqlNode = DummyLandscapeHelper.createNode("10.0.0.3",
     * postgreSqlNodeGroup, landscape);
     *
     * final Application postgreSql = DummyLandscapeHelper.createApplication("PostgreSQL",
     * postgreSqlNode, landscape);
     *
     ...
     *
     * final Node workflow1Node = DummyLandscapeHelper.createNode("10.0.0.4", workflowNodeGroup,
     * landscape); final Application workflow1 = DummyLandscapeHelper.createApplication("Workflow",
     * workflow1Node, landscape); final Application provenance1 =
     * DummyLandscapeHelper.createApplication("Provenance", workflow1Node, landscape);
     *
     * final Node workflow2Node = DummyLandscapeHelper.createNode("10.0.0.5", workflowNodeGroup,
     * landscape); final Application workflow2 = DummyLandscapeHelper.createApplication("Workflow",
     * workflow2Node, landscape); final Application provenance2 =
     * DummyLandscapeHelper.createApplication("Provenance", workflow2Node, landscape);
     *
     * final Node workflow3Node = DummyLandscapeHelper.createNode("10.0.0.6", workflowNodeGroup,
     * landscape); final Application workflow3 = DummyLandscapeHelper.createApplication("Workflow",
     * workflow3Node, landscape); final Application provenance3 =
     * DummyLandscapeHelper.createApplication("Provenance", workflow3Node, landscape);
     *
     * final Node workflow4Node = DummyLandscapeHelper.createNode("10.0.0.7", workflowNodeGroup,
     * landscape); final Application workflow4 = DummyLandscapeHelper.createApplication("Workflow",
     * workflow4Node, landscape); final Application provenance4 =
     ...
     * final Node webshopNode = DummyLandscapeHelper.createNode("10.0.0.9", webshopNodeGroup,
     * landscape); final Application webshop = DummyLandscapeHelper.createApplication("Webshop",
     * webshopNode, landscape); createWebshopApplication(webshop);
     *
     * webshopNodeGroup.getNodes().add(webshopNode); pubflow.getNodeGroups().add(webshopNodeGroup);
     *
     * final NodeGroup cacheNodeGroup = DummyLandscapeHelper.createNodeGroup("10.0.0.8", pubflow);
     * final Node cacheNode = DummyLandscapeHelper.createNode("10.0.0.8", cacheNodeGroup,
     * landscape);
     *
     * final Application cache = DummyLandscapeHelper.createApplication("Cache", cacheNode,
     * landscape);
     *
     ...
     *
     * cacheNodeGroup.getNodes().add(cacheNode); pubflow.getNodeGroups().add(cacheNodeGroup);
     *
     * DummyLandscapeHelper.createApplicationCommunication(requestsApp, ocnEditorApp, landscape,
     * 100);
     *
     ...
     * 100); DummyLandscapeHelper.createApplicationCommunication(ocnDatabaseApp, ocnDatabaseApp2,
     * landscape, 100); DummyLandscapeHelper.createApplicationCommunication(ocnEditorApp,
     * ocnEditorApp2, landscape, 100);
     * DummyLandscapeHelper.createApplicationCommunication(ocnDatabaseApp, workflow1, landscape,
     * 100); DummyLandscapeHelper.createApplicationCommunication(workflow1, pangeaApp, landscape,
     * 100);
     *
     * DummyLandscapeHelper.createApplicationCommunication(workflow1, kielprintsApp, landscape,
     * 100); DummyLandscapeHelper.createApplicationCommunication(kielprintsApp, kielprintsApp2,
     * landscape, 100); DummyLandscapeHelper.createApplicationCommunication(kielprintsApp2,
     * kielprintsApp3, landscape, 100);
     *
     ...
     *
     * DummyLandscapeHelper.createApplicationCommunication(cache, databaseConnector, landscape, 300
     * * 2);
     *
