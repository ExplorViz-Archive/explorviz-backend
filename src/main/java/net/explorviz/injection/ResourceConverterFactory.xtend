...
class ResourceConverterFactory implements Factory<ResourceConverter> {
	...
	new() {
		this.converter = new ResourceConverter(Timestamp, Landscape, net.explorviz.model.System, NodeGroup, Node,
			Application, Component, Clazz, CommunicationClazz, Communication, CommunicationAccumulator,
